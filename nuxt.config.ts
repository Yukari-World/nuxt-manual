	...
	vite: {
		plugins: [
			stylelint({
				fix: true,
				include: [
					'app/assets/**/*.{css,less,scss,sass,vue}',
					'app/components/**/*.{css,less,scss,sass,vue}',
					// 'app/content/**/*.{css,less,scss,sass,vue}',
					'app/layouts/**/*.{css,less,scss,sass,vue}',
					'app/pages/**/*.{css,less,scss,sass,vue}',
					'app/server/**/*.{css,less,scss,sass,vue}',
					// 'app/src/**/*.{css,less,scss,sass,vue}',
					// 'app/styles/**/*.{css,less,scss,sass,vue}',
					'app/app.vue',
					// 'app/error.vue',
					// 'app/Error.vue',
				],
