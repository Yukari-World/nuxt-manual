...
.category--css.page--gradation
	...
	section
		...
		.yw-gradient1
		p
			NuxtLink(to="https://dyaddemo.wordpress.com/", title="Dyad – A theme that pairs well with any content", target="_blank", rel="external noopener") dyad
			| で使用されている直線グラデーション。
			br
		...
		.yw-gradient2
		p
			NuxtLink(to="https://developer.mozilla.org/ja/docs/Web/CSS/linear-gradient", target="_blank", rel="external noopener") MDN Web Docs
